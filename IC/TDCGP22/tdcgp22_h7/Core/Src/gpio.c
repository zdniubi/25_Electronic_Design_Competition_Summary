...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, TDC_SSN_Pin|TDC_SCK_Pin|TDC_SI_Pin|TDC_RTN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PEPin PEPin PEPin PEPin */
  GPIO_InitStruct.Pin = TDC_SSN_Pin|TDC_SCK_Pin|TDC_SI_Pin|TDC_RTN_Pin;
