...
//模拟SPI时钟引脚---输出
#define SCK_H  HAL_GPIO_WritePin(AD_SCLK_GPIO_Port ,AD_SCLK_Pin,GPIO_PIN_SET)
#define SCK_L  HAL_GPIO_WritePin(AD_SCLK_GPIO_Port ,AD_SCLK_Pin,GPIO_PIN_RESET)

//模拟SPI数据输入引脚---输入
#define DOUT HAL_GPIO_ReadPin(AD_DOUT_GPIO_Port,AD_DOUT_Pin)

//模拟SPI数据输出引脚---输出
#define DIN_H  HAL_GPIO_WritePin(AD_DIN_GPIO_Port ,AD_DIN_Pin,GPIO_PIN_SET)
#define DIN_L  HAL_GPIO_WritePin(AD_DIN_GPIO_Port ,AD_DIN_Pin,GPIO_PIN_RESET)

//模拟SPI片选引脚---输出
#define CS_H  HAL_GPIO_WritePin(AD_SYNC_GPIO_Port ,AD_SYNC_Pin,GPIO_PIN_SET)
#define CS_L  HAL_GPIO_WritePin(AD_SYNC_GPIO_Port ,AD_SYNC_Pin,GPIO_PIN_RESET)
